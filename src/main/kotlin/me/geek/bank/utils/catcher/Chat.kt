package me.geek.bank.utils.catcher

import me.geek.bank.GeekItemRank
import me.geek.bank.api.bank.BankManage.getPlayerData
import me.geek.bank.api.bank.BankManage.getQuitItem
import me.geek.bank.api.bank.BankManage.remItemPack
import me.geek.bank.api.bank.BankManage.remQuitItem
...
import me.geek.bank.utils.getEmptySlot
                            ...
                            if (e.message.isInt()) {
                                ...
                                player.getQuitItem()?.let {
                                    player.getPlayerData()?.let { data ->
                                        ...
                                        val price = if (node != null) { node.take_Price * amt } else { Bank.getBankCache().DefaultTake_Price * amt }
