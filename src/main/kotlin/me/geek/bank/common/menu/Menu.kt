...
import me.geek.bank.common.menu.action.PointsShop
import me.geek.bank.common.menu.action.RankMenu
import me.geek.bank.utils.FileUtils.forFile
...
object Menu {
    ...
    fun Player.openMenu(MenuID: String) {
        ...
        when (sess.type) {
            "bank" -> RankMenu(this, sess, build(this, MenuID))
